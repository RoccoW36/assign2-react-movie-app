...
export default {
  title: "Fantasy Movie Details Page/FantasyMovieHeader",
...
export const Basic: StoryFn = (args) => <FantasyHeader movie={SampleFantasy} {...args} />;
Basic.storyName = "Header View";
export const Form: StoryFn = (args) => <FantasyHeader movie={null} {...args} />;
